...
impl ImageData {
    pub fn filter_metadata(&self, selected_keys: &HashSet<String>, include_basic_info: bool, include_gps: bool) -> Self {
        ...
        Self {
            ...
            height: if include_basic_info { self.height } else { None },
